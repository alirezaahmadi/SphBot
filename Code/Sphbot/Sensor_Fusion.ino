...
{
  roll=(0.5 * P_roll) + (0.5*(atan2(2 * (q0 * q1 + q2 * q3),1 - 2 * (q1 * q1 + q2 * q2))*RAD2DEG));
  pitch =(0.5 * P_pitch) + (0.5*(asin(2 * (q0 * q2 - q3 * q1))*RAD2DEG));
  yaw =(0.5 * P_yaw) + (0.5*  (atan2(2 * (q0 * q3 + q1 * q2) , 1 - 2* (q2 * q2 + q3 * q3))*RAD2DEG));
